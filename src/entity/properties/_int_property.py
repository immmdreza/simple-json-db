...
class IntProperty(TProperty[int]):
    ...
    def __init__(
        ...
        *,
        ...
        required: bool = False,
        default_factory: Optional[Callable[[], Optional[int]]] = None,
    ):
        ...
        Args:
            ...
            default_factory (`Optional[Callable[[], Optional[int]]]`, optional): A function that returns a default value for the property. Defaults to None.
        """
